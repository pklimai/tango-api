...
INSERT INTO att_conf (att_conf_id, att_name, att_conf_type_id, att_conf_format_id, att_conf_write_id, table_name, cs_name, domain, family, member, name, ttl, hide) VALUES
    ...
    (2, 'att_name_ad', 25, 1, 1, 'att_array_devdouble', 'cs_name_ad', 'domain_ad', 'family_ad', 'member_ad', 'name_ad', 0, false),
    ...
    (7, 'att_name_ab', 21, 1, 1, 'att_array_devboolean', 'cs_name_ab', 'domain_ab', 'family_ab', 'member_ab', 'name_ab', 0, false);
-- +goose StatementEnd
...
INSERT INTO att_array_devboolean (att_conf_id, data_time, value_r, value_w) VALUES
    (7, NOW(), ARRAY[true, false]::BOOLEAN[], ARRAY[true, false]::BOOLEAN[]),
    (7, NOW(), ARRAY[false, true]::BOOLEAN[], ARRAY[false, true]::BOOLEAN[]),
