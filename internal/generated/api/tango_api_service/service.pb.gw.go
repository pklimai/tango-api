...
/*
Package tango_api_service is a reverse proxy.
...
// RegisterTangoApiServiceHandlerServer registers the http handlers for service TangoApiService to "mux".
// UnaryRPC     :call TangoApiServiceServer directly.
...
func RegisterTangoApiServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterTangoApiServiceHandler(ctx, mux, conn)
}

// RegisterTangoApiServiceHandler registers the http handlers for service TangoApiService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterTangoApiServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterTangoApiServiceHandlerClient(ctx, mux, NewTangoApiServiceClient(conn))
}

// RegisterTangoApiServiceHandlerClient registers the http handlers for service TangoApiService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "TangoApiServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "TangoApiServiceClient"
